      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-14'>
        <ul className='grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 lg:gap-24 py-8 md:py-16'>
          ...
          >
            ...
            <h3 className='w-[260px] text-white md:text-2xl text-xl md:font-bold font-semibold leading-7 tracking-tight'>
          ...
          {/* Item 3 */}
          <li className='relative flex md:flex-col items-center md:items-start gap-4'>
            <span className='rounded-xl p-2 ring-1 ring-white/20 text-white'>
